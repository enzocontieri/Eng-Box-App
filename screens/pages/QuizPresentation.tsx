        ...
        <SafeAreaView>
            <ScrollView>
                <View className='items-center'>
                    ...
                    <AboutTextBox boxTextContent='O EngBox é uma ferramenta voltada para promover o consumo sustentável 
                    ...
                    <AboutTextBox boxTextContent='Para conhecermos um pouco mais sobre você e seus hábitos como consumidor, criamos um quiz interativo
                    ...
                    <View className=' items-center mt-6 w-4/5' >
                        ...
                        >
                            <Text className='text-xl text-white' style={{ fontFamily: "poppins-medium" }} >Ir para o Quiz</Text>
                        </TouchableOpacity>
